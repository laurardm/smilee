...
function acertou(obj) {
  ...
  img.id = "imagem";
  img.src = "https://play-lh.googleusercontent.com/proxy/m3uCbNk6rZpomiDVnyTYPz_PDlwG58AuFfLbsqdnU50rIqfC-tGzBacEq1H2BrWBDSiOqOqeDKDPY_3JRdiSQmRC1OTruqoTAC-OAUhXsWhZnY6rWl2X=s1920-w1920-h1080";
  obj.appendChild(img);
}
...
function adicionarImagemErro(obj) {
  const img = new Image(100);
  img.src = "https://static.wikia.nocookie.net/vozesportuguesas/images/1/18/Slyder.png/revision/latest/scale-to-width-down/80?cb=20220520225001&path-prefix=pt"; 
